...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mundo Vem — Service Desk" },
      { name: "description", content: "Portal oficial de chamados de TI e demais áreas da Mundo Vem." },
      { property: "og:title", content: "Mundo Vem — Service Desk" },
      { property: "og:description", content: "Portal oficial de chamados de TI e demais áreas da Mundo Vem." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Mundo Vem — Service Desk" },
      { name: "twitter:description", content: "Portal oficial de chamados de TI e demais áreas da Mundo Vem." },
